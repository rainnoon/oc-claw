...
export const ui = {
  en: {
    ...
    'hero.download.mac': 'Download for Mac (v1.6.1)',
  ...
  zh: {
    ...
    'hero.download.mac': '下载 Mac 版 (v1.6.1)',
  ...
  ja: {
    ...
    'hero.download.mac': 'Mac版をダウンロード (v1.6.1)',
  ...
  ko: {
    ...
    'hero.download.mac': 'Mac 다운로드 (v1.6.1)',
  ...
  es: {
    ...
    'hero.download.mac': 'Descargar para Mac (v1.6.1)',
  ...
  fr: {
    ...
    'hero.download.mac': 'Télécharger pour Mac (v1.6.1)',
