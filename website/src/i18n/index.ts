...
export const ui = {
  en: {
    ...
    'hero.download.mac': 'Download for Mac (v1.8.1)',
    'hero.download.win': 'Download for Windows (v1.8.1)',
  ...
  zh: {
    ...
    'hero.download.mac': '下载 Mac 版 (v1.8.1)',
    'hero.download.win': '下载 Windows 版 (v1.8.1)',
    'hero.badge': '开源项目',
  ...
  ja: {
    ...
    'hero.download.mac': 'Mac版をダウンロード (v1.8.1)',
    'hero.download.win': 'Windows版をダウンロード (v1.8.1)',
    'hero.badge': 'オープンソース',
  ...
  ko: {
    ...
    'hero.download.mac': 'Mac 다운로드 (v1.8.1)',
    'hero.download.win': 'Windows 다운로드 (v1.8.1)',
    'hero.badge': '오픈 소스',
  ...
  es: {
    ...
    'hero.download.mac': 'Descargar para Mac (v1.8.1)',
    'hero.download.win': 'Descargar para Windows (v1.8.1)',
  ...
  fr: {
    ...
    'hero.download.mac': 'Télécharger pour Mac (v1.8.1)',
    'hero.download.win': 'Télécharger pour Windows (v1.8.1)',
    'hero.badge': 'OPEN SOURCE',
